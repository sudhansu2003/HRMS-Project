<div class="card bg-none card-box">
    ...
    <div class="card-body">
        <a href="#" data-url="{{route('job.on.board.create', $interviewSchedule->candidate)}}"  data-ajax-popup="true"  class="btn btn-xs btn-white btn-icon-only width-auto" >  {{__('Add to Job OnBoard')}}</a>
    </div>
</div>
