<div class="card bg-none card-box">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('project_name', $projectNames->pluck('project_name','project_name') , null,array('class' => 'form-control font-style select2','required'=>'required'))); ?>
...
<?php /**PATH C:\xampp\htdocs\HRMS\resources\views/timeSheet/create.blade.php ENDPATH**/ ?>