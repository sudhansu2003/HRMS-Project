    ...
    <div class="scrollbar-inner">
        <div class="div-mega">
            <ul class="navbar-nav navbar-nav-docs">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('monthlyreport.index')); ?>" class="nav-link">
                        <i class="fas fa-flag"></i><?php echo e(__('Monthly Report')); ?>

                    </a>
                </li>
                        <li class="nav-item">
                            <a class="nav-link " href="#navbar-project" data-toggle="collapse" role="button" aria-expanded="" aria-controls="navbar-staff">
                                <i class="fas fa-project-diagram"></i><?php echo e(__('Project')); ?>
                            ...
                            <div class="collapse" id="navbar-project">
                                <ul class="nav flex-column submenu-ul">
                                        <li class="nav-item">
                                            <a href=" <?php echo e(route('projectdetails.index')); ?> " class="nav-link"><?php echo e(__('Project Details')); ?></a>
                                        </li>
                                    
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('projectassigns.assignindex')); ?>" class="nav-link"><?php echo e(__('Project Assigns')); ?></a>
                                        </li>
                                </ul>
                            </div>
                        </li>
                                    ...
                                    <li class="nav-item submenu-li">
                                        ...
                                        <div class="collapse submenu-ul <?php echo e((Request::route()->getName() == 'attendanceemployee.index' || Request::route()->getName() == 'attendanceemployee.bulkattendance') ? 'show' : ''); ?>" id="navbar-attendance">
                                            <ul class="nav flex-column">
                                                ...
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Manage Attendance')): ?>
                                                    <li class="nav-item <?php echo e((Request::route()->getName() == 'attendanceemployee.manageattendance') ? 'active' : ''); ?>">
                                                        <a href="<?php echo e(route('attendanceemployee.manageattendance')); ?>" class="nav-link"><?php echo e(__('Manage Attendance')); ?></a>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
...
<?php /**PATH C:\xampp\htdocs\HRMS\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>