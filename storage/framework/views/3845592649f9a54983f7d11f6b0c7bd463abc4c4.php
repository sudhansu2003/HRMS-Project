...
<head>
    ...
    <title>
        <?php echo e((Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'HRMS')); ?> - <?php echo $__env->yieldContent('page-title'); ?>
    </title>
...
<?php exit();?>
<?php /**PATH C:\xampp\htdocs\HRMS\resources\views/layouts/auth.blade.php ENDPATH**/ ?>